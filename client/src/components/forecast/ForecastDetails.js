...
const ForecastDetails = ({ chartSelected, day, isCelsiusScale, name, onChangeChart, onChangeScale, state }) => {
    ...
    <div className="forecast-panel-details">
      ...
      <div className="flex-column forecast-panel-details-info-right">
        ...
        <div className="btn-group-chart">
          <button className={chartSelected === 0 ? "btn-chart-active" : "btn-chart"} onClick={() => onChangeChart(0)}>Temperatura</button>
          <button className={chartSelected === 1 ? "btn-chart-active" : "btn-chart"} onClick={() => onChangeChart(1)}>Umidade</button>
          <button className={chartSelected === 2 ? "btn-chart-active" : "btn-chart"} onClick={() => onChangeChart(2)}>Vento</button>
        </div>
      </div>
    </div>
  );
